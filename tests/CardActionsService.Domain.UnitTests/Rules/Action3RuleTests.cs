...
{
    [TestFixture]
    public class Action3RuleTests
    {
        private Action3Rule _rule;

        private const string CardNumber = "Card123456789";

        [SetUp]
        public void SetUp() => _rule = new Action3Rule();

        [Test]
        public void IsApplicable_ShouldAlwaysReturnTrue()
        {
            var card = new CardDetails(CardNumber, CardType.Credit, CardStatus.Blocked, true);
