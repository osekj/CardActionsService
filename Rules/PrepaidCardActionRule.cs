...
{
    public class PrepaidCardActionRule : ICardActionRule
    {
        public bool IsApplicable(CardDetails cardDetails)
        {
            return cardDetails.CardType == CardType.Prepaid;
        }

        public IReadOnlyList<CardAction> GetAllowedActions(CardDetails cardDetails)
        {
            return new List<CardAction> { CardAction.ACTION1, CardAction.ACTION2, CardAction.ACTION3, CardAction.ACTION4, CardAction.ACTION6, CardAction.ACTION7,
